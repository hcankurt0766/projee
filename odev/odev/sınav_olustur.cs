...
namespace odev
{
    public partial class sınav_olustur : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'test2DataSet5.alt_kategori' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.alt_kategoriTableAdapter.Fill(this.test2DataSet5.alt_kategori);
