...
namespace odev
{
    public partial class Soru_ekle : Form
    {
        ...
        private void Soru_ekle_Load(object sender, EventArgs e)
        {
            ...
            this.alt_kategoriTableAdapter.Fill(this.test2DataSet9.alt_kategori);
            // TODO: Bu kod satırı 'test2DataSet8.kategori' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.kategoriTableAdapter.Fill(this.test2DataSet8.kategori);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                asd.mailservice("hcandeneme@gmail.com", ex.ToString(),session.kullaniciad);
