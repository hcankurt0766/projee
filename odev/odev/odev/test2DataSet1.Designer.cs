...
SELECT kullanici_id, kullanici_adi, kullanici_mail, kullanici_sifre, aktif, yetki FROM kullanici WHERE (kullanici_id = @kullanici_id)";
        ...
        public virtual int Fill(test2DataSet1.kullaniciDataTable dataTable) {
        ...
        public virtual test2DataSet1.kullaniciDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            test2DataSet1.kullaniciDataTable dataTable = new test2DataSet1.kullaniciDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(test2DataSet1.kullaniciDataTable dataTable) {
